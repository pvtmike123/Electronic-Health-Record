...
class MedicalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medical" do
    assert_difference('Medical.count') do
      post medicals_url, params: { medical: { allergies: @medical.allergies, smoker: @medical.smoker } }
    end
  ...
  test "should update medical" do
    patch medical_url(@medical), params: { medical: { allergies: @medical.allergies, smoker: @medical.smoker } }
